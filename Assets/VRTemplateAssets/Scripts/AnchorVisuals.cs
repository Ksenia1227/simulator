// управление анимацией визуальных эффектов якоря телепорта в VR. Конкретно, он управляет анимацией стрелки, 
// которая указывает на платформу телепортации, 
// а также управляет ее видимостью и высотой в зависимости от взаимодействия с телепортером.
using System;

// Этот код представляет собой компонент, который позволяет контролировать вращение объекта в виртуальной реальности (VR) 
// при его захвате и манипуляции с ним, используя систему XR Interaction Toolkit.
//  Конкретно, он ограничивает вращение объекта только по выбранным осям, сохраняя начальные углы вращения на тех осях,
//  которые не были выбраны для изменения.
